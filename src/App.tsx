...
function App() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#f8f9fa' }}>
      <header className="text-white py-6 shadow-md" style={{ backgroundColor: '#273376' }}>
      ...
      <footer className="text-white py-6 mt-12" style={{ backgroundColor: '#273376' }}>
        <div className="container mx-auto px-4 text-center">
          <p>&copy; {new Date().getFullYear()} Biblioteca Nacional de Venezuela. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
